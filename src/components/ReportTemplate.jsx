export default function ReportTemplate({ report }) {
  ...
  return (
    <div className="bg-white text-gray-900 max-w-[794px] mx-auto shadow print:shadow-none relative overflow-hidden">
      {/* subtle watermark */}
      ...
      <div className="relative border-b">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            <img src="/images/logo.png" alt="Hospital" className="h-10 w-auto" />
            <div>
              <div className="text-[10px] uppercase tracking-wider text-gray-600">DEPARTMENT OF LABORATORY MEDICINE</div>
              <div className="text-base font-semibold tracking-wide">CLINICAL PATHOLOGY REPORT</div>
            </div>
          </div>
      ...
      <div className="px-4 pb-4 relative">
        ...
        {report.notes ? (
          <div className="mt-4 text-[11px]"><span className="text-gray-600">Impression</span>: {report.notes}</div>
        ) : null}
      </div>
